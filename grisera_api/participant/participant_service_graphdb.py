...
class ParticipantServiceGraphDB(ParticipantService):
    ...
    def get_participant(self, participant_id: int, dataset_name: str):
        """
    ...
    def delete_participant(self, participant_id: int, dataset_name: str):
        """
    ...
    def update_participant(self, participant_id: int, participant: ParticipantIn, dataset_name: str):
        """
