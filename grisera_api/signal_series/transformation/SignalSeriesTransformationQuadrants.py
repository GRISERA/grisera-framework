...
class SignalSeriesTransformationQuadrants(SignalSeriesTransformation):
    """
    ...
    def transform(self, signal_series: List[SignalSeriesOut], additional_properties: Optional[List[PropertyIn]]):
        ...
        """
        assert len(
            signal_series) == 2, "Number of time series should equals 2 for quadrants transformation"
        ...
        additional_properties.append(PropertyIn(
            key="transformation_name", value=TransformationType.QUADRANTS))
        ...
        for current_signal_value_x in signal_series[0].signal_values:
            ...
            if current_signal_value_y_index < len(signal_series[1].signal_values) and \
                ...
                quadrant = 1 + [(1, 1), (0, 1), (0, 0), (1, 0)
                                ].index((x_positive, y_positive))
