...
class AppearanceRouter:
    ...
    async def get_appearance(self, appearance_id: Union[int, str], depth: int, response: Response):
        """
    ...
    @router.delete("/appearance/{appearance_id}", tags=["appearance"],
                   response_model=Union[AppearanceSomatotypeOut, AppearanceOcclusionOut, NotFoundByIdModel])
    async def delete_appearance(self, appearance_id: Union[int, str], response: Response):
        """
    ...
    async def update_appearance_occlusion(self, appearance_id: Union[int, str], appearance: AppearanceOcclusionIn,
                                          response: Response):
        """
    ...
    async def update_appearance_somatotype(self, appearance_id: Union[int, str], appearance: AppearanceSomatotypeIn,
                                           response: Response):
        """
