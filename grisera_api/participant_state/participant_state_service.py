...
from participant_state.participant_state_model import ParticipantStateIn, ParticipantStateOut, \
    BasicParticipantStateOut, ParticipantStatesOut, ParticipantStateRelationOut, ParticipantStateRelationIn
...
class ParticipantStateService:
    ...
    def save_participant_state(self, participant_state: ParticipantStateRelationIn):
        """
        ...
        if participant_state.participant_id is not None:
        ...
        personality_id = participant_state.personality_id
        appearance_id = participant_state.appearance_id
        ...
        return ParticipantStateOut(participant_id=participant_id, age=participant_state.age,
                                   personality_id=personality_id, appearance_id=appearance_id, id=participant_state_id,
    ...
    def get_participant_state(self, participant_state_id: int):
        ...
        return ParticipantStateRelationOut(**participant_state)
    ...
    def delete_participant_state(self, participant_state_id: int):
        ...
        delete_response = self.graph_api_service.delete_node(participant_state_id)
        ...
        return ParticipantStateOut(**participant)

    def update_participant_state(self, participant_state_id: int, participant_state: ParticipantStateIn):
        """
        Send request to graph api to update given participant state

        Args:
            participant_state_id (int): Id of participant state
            participant_state (ParticipantStateIn): Properties to update
