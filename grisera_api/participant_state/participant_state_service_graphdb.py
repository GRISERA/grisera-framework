...
class ParticipantStateServiceGraphDB(ParticipantStateService):
    ...
    def save_participant_state(self, participant_state: ParticipantStateIn, dataset_name: str):
        ...
        if participant_state.participant_id is not None and \
                type(self.participant_service.get_participant(participant_state.participant_id, dataset_name=dataset_name)) is not NotFoundByIdModel:
        ...
        if participant_state.personality_id is not None and \
                type(self.personality_service.get_personality(participant_state.personality_id, dataset_name=dataset_name)) is not NotFoundByIdModel:
            self.graph_api_service.create_relationships(start_node=participant_state_id,
                                                        end_node=participant_state.personality_id,
                                                        name="hasPersonality",
                                                        dataset_name=dataset_name)
        if participant_state.appearance_id is not None and \
                type(self.appearance_service.get_appearance(participant_state.appearance_id, dataset_name=dataset_name)) is not NotFoundByIdModel:
            self.graph_api_service.create_relationships(start_node=participant_state_id,
    ...
    def get_participant_state(self, participant_state_id: int, dataset_name: str):
        """
    ...
    def delete_participant_state(self, participant_state_id: int, dataset_name: str):
        """
    ...
    def update_participant_state(self, participant_state_id: int, participant_state: ParticipantStatePropertyIn, dataset_name: str):
        """
    ...
    def update_participant_state_relationships(self, participant_state_id: int,
                                               participant_state: ParticipantStateRelationIn, dataset_name: str):
        """
        Send request to graph api to update given participant state
        ...
        if participant_state.participant_id is not None and \
            ...
            self.graph_api_service.create_relationships(start_node=participant_state_id,
                                                        ...
                                                        dataset_name=dataset_name)
        if participant_state.personality_id is not None and \
                type(self.personality_service.get_personality(participant_state.personality_id, dataset_name)) is not NotFoundByIdModel:
            self.graph_api_service.create_relationships(start_node=participant_state_id,
                                                        end_node=participant_state.personality_id,
                                                        name="hasPersonality",
                                                        dataset_name=dataset_name)
        if participant_state.appearance_id is not None and \
                type(self.appearance_service.get_appearance(participant_state.appearance_id, dataset_name)) is not NotFoundByIdModel:
            self.graph_api_service.create_relationships(start_node=participant_state_id,
                                                        end_node=participant_state.appearance_id,
                                                        name="hasAppearance",
                                                        dataset_name=dataset_name)
