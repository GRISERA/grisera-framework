...
class ExperimentRouter:
    ...
    async def get_experiment(self, experiment_id: Union[int, str], depth: int, response: Response):
        """
    ...
    @router.put("/experiments/{experiment_id}", tags=["experiments"],
                response_model=Union[ExperimentOut, NotFoundByIdModel])
    async def update_experiment(self, experiment_id: Union[int, str], experiment: ExperimentIn, response: Response):
        """
