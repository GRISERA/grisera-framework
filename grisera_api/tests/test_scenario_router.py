...
class TestScenarioRouter(unittest.TestCase):
    ...
    def test_create_scenario_without_error(self, save_scenario_mock):
        save_scenario_mock.return_value = ScenarioOut(experiment_id=2, activity_executions=[ActivityExecutionOut(activity='group', identifier=1)], id=1)
        response = Response()
        ...
        self.assertEqual(result, ScenarioOut(experiment_id=2, activity_executions=[ActivityExecutionOut(activity='group', identifier=1)], id=1,
    ...
    def test_create_scenario_with_error(self, save_scenario_mock):
        save_scenario_mock.return_value = ScenarioOut(experiment_id=2, activity_executions=[ActivityExecutionIn(activity='group',
                                                                                                       identifier=1)],
                                                      errors={'errors': ['test']})
        response = Response()
        scenario = ScenarioIn(experiment_id=2, activity_executions=[ActivityExecutionIn(activity='group', identifier=1)])
        ...
        self.assertEqual(result,  ScenarioOut(experiment_id=2, activity_executions=[ActivityExecutionOut(activity='group', identifier=1)],
    ...
    def test_add_activity_execution_without_error(self, add_activity_execution_mock):
        add_activity_execution_mock.return_value = ActivityExecutionOut(activity='group', identifier=2, id=1)
        response = Response()
        ...
        self.assertEqual(result, ActivityExecutionOut(activity='group', identifier=2, id=1, links=get_links(router)))
    ...
    def test_add_activity_execution_with_error(self, add_activity_execution_mock):
        add_activity_execution_mock.return_value = ActivityExecutionOut(activity='group', identifier=2, errors={'errors': ['test']})
        response = Response()
        activity_execution = ActivityExecutionIn(activity='group', identifier=2)
        scenario_router = ScenarioRouter()
        ...
        self.assertEqual(result, ActivityExecutionOut(activity='group', identifier=2, errors={'errors': ['test']}, links=get_links(router)))
        add_activity_execution_mock.assert_called_once_with(1, activity_execution)
        self.assertEqual(response.status_code, 422)
