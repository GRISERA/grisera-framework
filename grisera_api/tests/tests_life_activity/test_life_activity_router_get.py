...
class TestLifeActivityRouterGet(unittest.TestCase):
    ...
    @mock.patch.object(LifeActivityService, 'get_life_activity')
    ...
    @mock.patch.object(LifeActivityService, 'get_life_activities')
    def test_get_life_activity_nodes_without_error(self, get_life_activities_mock):
        ...
        result = asyncio.run(life_activity_router.get_life_activities(response))
