...
class TestRecordingServicePut(unittest.TestCase):
    ...
    def test_update_recording_relationships_without_error(self, get_node_relationships_mock,
        ...
        recording_in = RecordingIn(channel_id=15, registered_data_id=19)
        recording_out = RecordingOut(id=id_node, relations=
        ...
        result = recording_service.update_recording_relationships(id_node, recording_in)
    ...
    @mock.patch.object(GraphApiService, 'get_node')
    def test_update_recording_relationships_without_label(self, get_node_mock):
        id_node = 1
    ...
    @mock.patch.object(GraphApiService, 'get_node')
    def test_update_recording_relationships_with_error(self, get_node_mock):
        id_node = 1
