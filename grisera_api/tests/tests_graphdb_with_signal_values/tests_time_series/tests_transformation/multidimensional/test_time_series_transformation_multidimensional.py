...
from time_series.transformation.multidimensional.SignalSeriesTransformationMultidimensional import \
    SignalSeriesTransformationMultidimensional


class TestSignalSeriesTransformationMultidimensional(unittest.TestCase):
    ...
    def test_transform_timestamp(self):
        time_series_transformation = SignalSeriesTransformationMultidimensional()
        result = time_series_transformation.transform(
            self.time_series_timestamp)
