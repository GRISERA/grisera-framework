...
class TestAppearanceRouterPut(unittest.TestCase):
    ...
    def test_update_appearance_occlusion_without_error(self, update_appearance_occlusion_mock):
        appearance_id = 1
        update_appearance_occlusion_mock.return_value = AppearanceOcclusionOut(beard="Heavy", moustache="Heavy",
                                                                               id=appearance_id)
        response = Response()
    ...
    def test_update_appearance_somatotype_without_error(self, update_appearance_somatotype_mock):
        appearance_id = 1
        update_appearance_somatotype_mock.return_value = AppearanceSomatotypeOut(glasses=False, ectomorph=2.7,
