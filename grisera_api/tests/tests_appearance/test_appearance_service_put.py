...
class TestAppearanceServicePut(unittest.TestCase):
    ...
    def test_update_appearance_occlusion_without_error(self, get_node_mock, create_properties_mock):
        id_node = 1
        ...
        appearance_out = AppearanceOcclusionOut(id=id_node, beard="Heavy", moustache="No")
    ...
    @mock.patch.object(GraphApiService, 'create_properties')
    @mock.patch.object(GraphApiService, 'get_node')
    def test_update_appearance_somatotype_without_error(self, get_node_mock, create_properties_mock):
        id_node = 1
        create_properties_mock.return_value = {}
        get_node_mock.return_value = {'id': id_node, 'labels': ['Appearance'],
    ...
    @mock.patch.object(GraphApiService, 'get_node')
    def test_update_appearance_occlusion_without_appearance_label(self, get_node_mock):
        id_node = 1
    ...
    @mock.patch.object(GraphApiService, 'get_node')
    def test_update_appearance_somatotype_without_appearance_label(self, get_node_mock):
        id_node = 1
        get_node_mock.return_value = {'id': id_node, 'labels': ['Test'], 'properties': None,
                                      "errors": None, 'links': None}
        not_found = NotFoundByIdModel(id=id_node, errors="Node not found.")
    ...
    @mock.patch.object(GraphApiService, 'get_node')
    def test_update_appearance_occlusion_with_error(self, get_node_mock):
        id_node = 1
    ...
    @mock.patch.object(GraphApiService, 'get_node')
    def test_update_appearance_somatotype_with_error(self, get_node_mock):
        id_node = 1
        get_node_mock.return_value = {'id': id_node, 'errors': ['error'], 'links': None}
        not_found = NotFoundByIdModel(id=id_node, errors=['error'])
        appearance_in = AppearanceSomatotypeIn(glasses=True, ectomorph=1.5, endomorph=1.5, mesomorph=1.5)
