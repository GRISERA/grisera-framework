...
class TestActivityExecutionServicePut(unittest.TestCase):
    ...
    def test_update_activity_execution_relationships_without_error(self, get_node_relationships_mock, delete_node_properties_mock,
        ...
        activity_execution_in = ActivityExecutionIn(activity_id=15, arrangement_id=19)
        activity_execution_out = ActivityExecutionOut(id=id_node, relations=
        ...
        result = activity_execution_service.update_activity_execution_relationships(id_node, activity_execution_in)
    ...
    @mock.patch.object(GraphApiService, 'get_node')
    def test_update_activity_execution_relationships_without_label(self, get_node_mock):
        id_node = 1
    ...
    @mock.patch.object(GraphApiService, 'get_node')
    def test_update_activity_execution_relationships_with_error(self, get_node_mock):
        id_node = 1
