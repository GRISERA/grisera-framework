...
def return_activity_execution(*args, **kwargs):
    activity_execution_out = ActivityExecutionOut(activity='group', arrangement_type='personal group', id=1)
...
class TestActivityExecutionRouter(unittest.TestCase):
    ...
    def test_create_activity_execution_without_error(self, save_activity_execution_mock):
        ...
        self.assertEqual(result, ActivityExecutionOut(activity='group', arrangement_type='personal group', id=1, links=get_links(router)))
