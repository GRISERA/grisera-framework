...
class TestParticipantServicePost(unittest.TestCase):
    ...
    def test_save_participant_without_error(self, create_properties_mock, create_node_mock):
        ...
        result = participant_service.save_participant(participant, database_name)

        self.assertEqual(result, ParticipantOut(name="Test Test", sex='male', id=id_node,
                                                additional_properties=additional_properties))
        create_node_mock.assert_called_once_with('Participant', database_name)
        create_properties_mock.assert_called_once_with(id_node, participant, database_name)
