...
class TestAppearanceServiceGet(unittest.TestCase):
    ...
    def test_get_appearance_occlusion_without_error(self, get_node_mock):
        ...
        #          "properties": None}]}
        #     appearance = BasicAppearanceOcclusionOut(
        #         **{'id': id_node, 'glasses': True, 'beard': "Heavy", 'moustache': "Heavy"})
        #     appearance_service = AppearanceServiceGraphDB()
        #
    ...
    def test_get_appearance_somatotype_without_error(self, get_node_mock):
        ...
        get_node_mock.return_value = {'id': id_node, 'labels': ['Appearance'],
                                      ...
                                      'errors': None, 'links': None}
        appearance = BasicAppearanceSomatotypeOut(**{'id': id_node, 'ectomorph': 1.5, 'endomorph': 1.5, 'mesomorph': 1.5})
        appearance_service = AppearanceServiceGraphDB()
