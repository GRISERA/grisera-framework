...
class TestAppearanceRouterDelete(unittest.TestCase):
    ...
    def test_delete_appearance_without_error(self, delete_appearance_mock):
        ...
        result = asyncio.run(appearance_router.delete_appearance(appearance_id, response, dataset_name))
        ...
        delete_appearance_mock.assert_called_once_with(appearance_id, dataset_name)
