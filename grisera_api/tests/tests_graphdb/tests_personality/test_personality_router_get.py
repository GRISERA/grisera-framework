...
class TestPersonalityRouterGet(unittest.TestCase):
    ...
    def test_get_personality_without_error(self, get_personality_mock):
        ...
        result = asyncio.run(personality_router.get_personality(personality_id, response, database_name))
        ...
        get_personality_mock.assert_called_once_with(personality_id, database_name)
    ...
    def test_get_personalities_without_error(self, get_personalities_mock):
        ...
        result = asyncio.run(personality_router.get_personalities(response, database_name))
