...
class TestPersonalityServicePost(unittest.TestCase):
    ...
    def test_save_personality_big_five_without_error(self, create_properties_mock, create_node_mock):
        ...
        result = personality_service.save_personality_big_five(personality, database_name)
        ...
        create_node_mock.assert_called_once_with('Personality', database_name)
        create_properties_mock.assert_called_once_with(id_node, personality, database_name)
    ...
    def test_save_personality_panas_without_error(self, create_properties_mock, create_node_mock):
        ...
        result = personality_service.save_personality_panas(personality, database_name)
