...
class TestPersonalityServicePost(unittest.TestCase):
    ...
    def test_save_personality_big_five_without_error(self, create_properties_mock, create_node_mock):
        ...
        result = personality_service.save_personality_big_five(personality, dataset_name)
        ...
        create_node_mock.assert_called_once_with('Personality', dataset_name)
        create_properties_mock.assert_called_once_with(id_node, personality, dataset_name)
    ...
    def test_save_personality_panas_without_error(self, create_properties_mock, create_node_mock):
        ...
        result = personality_service.save_personality_panas(personality, dataset_name)
