...
class TestRegisteredDataRouterPut(unittest.TestCase):
    ...
    def test_update_registered_data_without_error(self, update_registered_data_mock):
        ...
        result = asyncio.run(registered_data_router.update_registered_data(registered_data_id, registered_data, response, database_name))
        ...
        update_registered_data_mock.assert_called_once_with(registered_data_id, registered_data, database_name)
