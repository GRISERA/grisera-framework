...
class TestArrangementService(unittest.TestCase):
    ...
    def test_save_arrangement_without_error(self, create_properties_mock, create_node_mock):
        ...
        create_properties_mock.return_value = {'id': id_node, 'properties': [{'key': 'arrangement_type', 'value': 'personal two persons'},
