...
class ObservableInformationRouter:
    ...
    async def get_observable_information(self, observable_information_id: Union[int, str], depth: int,
                                         response: Response):
        """
        ...
        get_response = self.observable_information_service.get_observable_information(observable_information_id, depth)
    ...
    @router.delete("/observable_information/{observable_information_id}", tags=["observable information"],
                   response_model=Union[ObservableInformationOut, NotFoundByIdModel])
    async def delete_observable_information(self, observable_information_id: Union[int, str], response: Response):
        """
    ...
    @router.put("/observable_information/{observable_information_id}/relationships", tags=["observable information"],
                response_model=Union[ObservableInformationOut, NotFoundByIdModel])
    async def update_observable_information_relationships(self, observable_information_id: Union[int, str],
