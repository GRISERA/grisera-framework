...
class TimeSeriesServiceGraphDBWithSignalValues(TimeSeriesServiceGraphDB):
    ...
    def transform_time_series(self, time_series_transformation: TimeSeriesTransformationIn, dataset_name):
        ...
        assert len(new_signal_values_id_mapping) == len(result.signal_values), "transformation signal values mapping does not have correct length"
    ...
    def create_signal_value(self, signal_value: SignalValueNodesIn, previous_signal_value_node, time_series_id: int, dataset_name: str):
        signal_value_node_response = self.graph_api_service.create_node("Signal Value", dataset_name)
    ...
    def get_time_series(self, time_series_id: Union[int, str], dataset_name: str, depth: int = 0,
        ...
        Returns:
            Result of request as time series object
        """
        time_series = super().get_time_series(time_series_id, dataset_name, depth)
    ...
    def get_signal_values(self, time_series_id: Union[int, str], time_series_type: str, dataset_name: str,
                          signal_min_value: Optional[int] = None,
                          signal_max_value: Optional[int] = None):
        """
    ...
    def get_time_series_nodes(self, dataset_name, params: QueryParams = None):
        """
