...
class RecordingRouter:
    ...
    async def get_recording(self, recording_id: Union[int, str], depth: int, response: Response):
        """
    ...
    @router.put("/recordings/{recording_id}", tags=["recordings"],
                response_model=Union[RecordingOut, NotFoundByIdModel])
    async def update_recording(self, recording_id: Union[int, str], recording: RecordingPropertyIn, response: Response):
        """
    ...
    @router.put("/recordings/{recording_id}/relationships", tags=["recordings"],
                response_model=Union[RecordingOut, NotFoundByIdModel])
    async def update_recording_relationships(self, recording_id: Union[int, str], recording: RecordingRelationIn,
                                             response: Response):
        """
