...
class ScenarioRouter:
    ...
    async def add_activity_execution(self, previous_id: Union[int, str], activity_execution: ActivityExecutionIn,
                                     response: Response):
        """
    ...
    async def get_scenario(self, node_id: Union[int, str], depth: int, response: Response):
        """
