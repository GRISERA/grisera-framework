...
class PersonalityRouter:
    ...
    async def get_personality(self, personality_id: Union[int, str], depth: int, response: Response):
        """
    ...
    @router.delete("/personality/{personality_id}", tags=["personality"],
                   response_model=Union[PersonalityBigFiveOut, PersonalityPanasOut, NotFoundByIdModel])
    async def delete_personality(self, personality_id: Union[int, str], response: Response):
        """
    ...
    async def update_personality_big_five(self, personality_id: Union[int, str], personality: PersonalityBigFiveIn,
                                          response: Response):
        """
    ...
    async def update_personality_panas(self, personality_id: Union[int, str], personality: PersonalityPanasIn,
                                       response: Response):
        """
