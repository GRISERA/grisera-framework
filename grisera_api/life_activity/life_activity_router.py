...
class LifeActivityRouter:
    ...
    async def get_life_activity(self, life_activity_id: int, response: Response, dataset_name: str):
        """
        Get life activity from database
        """
        get_response = self.life_activity_service.get_life_activity(life_activity_id, dataset_name)
